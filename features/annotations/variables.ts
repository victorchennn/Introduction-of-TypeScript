...
// TypeScript will figure out the type automatically
let apples: number = 5; // same as let apples = 5;
...
const coordinations: { x: number; y: number } = JSON.parse(json); // JSON.parse return 'any' type, need annotation
